$(function() {
	...
	c.load("<div class='bef_comment writecode'>&nbsp;*hi,我的名字叫卓创财，是一名Web前端工程师</div>");
	c.load("<div class='bef_comment writecode'>&nbsp;*我的主要工作是进行网站开发,优化,完善的工作</div>",2000);
	...
	w.load("<p><div class='writecode'>卓创财</div>");
	w.load("<div class='writecode'>Web前端工程师</div></p>");
	w.load("<h1 class='writecode'>联系方式</h1>");
	w.load("<ul>");
	w.load("<li class='writecode'>&nbsp;email:Cliock_zhuo@163.com</li>");
	w.load("<li class='writecode'>github:<a href='https://github.com/Chilko' target='_blank'>https://github.com/Chilko</a></li>");
	w.load("<li class='writecode'>mobile:137-5056-2894</li>");
	w.load("</ul>");
	w.load("<h1 class='writecode'>职业技能</h1>");
	w.load("<ul>");
	w.load("<li class='writecode'>熟练掌握 HTML,和CSS等Web开发技术进行页面架构和布局</li>");
	w.load("<li class='writecode'>熟练掌握 js,DOM,BOM,能够兼容各种浏览器</li>");
	w.load("<li class='writecode'>熟练掌握 HTML5,CSS3,Sass熟悉ES6新特新</li>");
	w.load("<li class='writecode'>熟练掌握 MVVM框架Vue全家桶</li>");
	w.load("<li class='writecode'>熟&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;悉 JQuery,Bootstrap等框架</li>");
	w.load("<li class='writecode'>熟&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;悉 webpack模板构建工具,Git版本控制工具</li>");
	w.load("</ul>");
	w.load("<h1 class='writecode'>个人项目</h1>");
	w.load("<ul>");
	w.load("<li class='writecode'><a href='https://github.com/Chilko/test/tree/master/yyszs' target='_blank'>阴阳师助手app</a></li>");
	w.load("<li class='writecode'><a href='https://github.com/Chilko/test/tree/master/douban' target='_blank'>简易豆瓣网</a></li>");
	w.load("<li class='writecode'><a href='https://github.com/Chilko/test/tree/master/NeteaseCloudWebApp' target='_blank'>网易云音乐App</a></li>");
	w.load("</ul>");
	c.load("<p><div class='comment writecode'>/**</div>");
	...
	c.load("<div class='comment writecode'>&nbsp;*QQ/微信:1004107147</div>");
	c.load("<div class='comment writecode'>&nbsp;*mobile:137-5056-2894</div>");
